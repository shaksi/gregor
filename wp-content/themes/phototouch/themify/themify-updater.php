...
function themify_check_version(){
	...
	if($_GET['success'] == 'true' && $_GET['upgrade_type'] == 'theme'){
		$notifications .= sprintf( __('<p class="success">Successfully updated %s to version %s.', 'themify'), $theme['Name'], $theme['Version'] );	
	}
	if($_GET['success'] == 'true' && $_GET['upgrade_type'] == 'framework'){
		$notifications .= sprintf( __( '<p class="success">Successfully updated the Themify framework to version %s</p>', 'themify'), $version);
	}

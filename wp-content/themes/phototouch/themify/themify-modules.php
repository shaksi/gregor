...
/***************************************************************************/
	...
	function themify_favicon($data=array()){
		...
		return '<p>
					...
					<span class="pushlabel" style="display:block;">
						<a href="#" class="upload-btn upload-image favicon" id="setting-'.$data['category'].'-'.$data['title'].'">' . __('+ Upload', 'themify') . '</a>
					</span>
				</p>';
	}
	...
	function themify_img_settings($data=array()){
		...
		$output = '<div class="module">
				...
				<div class="row">
					<input type="checkbox" name="setting-img_settings_use" '.$checked_use.'/> ' . __('Disable img.php globally', 'themify') . '<br>
					<small>' . __('(original source images will be used)', 'themify') . '</small>
				</div>
	...
	function themify_shortcode_settings($data=array()){
		...
		$output .= '<p><span class="label">' . __('Google Map', 'themify') . '</span><input type="checkbox" name="setting-google_map_script" '.$shortcode_checked.' /> ' . __('Exclude Google Map API', 'themify') . ' <br> <small>' . __('(if you don\'t use the map <a href="http://themify.me/docs/shortcodes" target="_blank">shortcode</a>, check this to optimize your theme)', 'themify') . '</small></p>';	
		$shortcode_checked = "";
		if($data['setting-video_player_script']){
			$shortcode_checked = "checked='checked'";	
		}
		$output .= '<p><span class="label">' . __('Video Player', 'themify') . '</span><input type="checkbox" name="setting-video_player_script" '.$shortcode_checked.' /> ' . __('Exclude Video Player Javascript', 'themify') . ' <br> <small>' . __('(if you don\'t use the video <a href="http://themify.me/docs/shortcodes" target="_blank">shortcode</a>, check this to optimize your theme)', 'themify') . '</small></p>';	
		$shortcode_checked = "";
		if($data['setting-slider_script']){
			$shortcode_checked = "checked='checked'";	
		}
		$output .= '<p><span class="label">' . __('Slider', 'themify') . '</span><input type="checkbox" name="setting-slider_script" '.$shortcode_checked.' /> ' . __('Exclude Slider Javascript', 'themify') . ' <br> <small>' . __('(if you don\'t use the slider <a href="http://themify.me/docs/shortcodes" target="_blank">shortcode</a>, check this to optimize your theme)', 'themify') . '</small></p>';	
		$shortcode_checked = "";
		if($data['setting-shortcode_css']){
			$shortcode_checked = "checked='checked'";	
		}
		$output .= '<p><span class="label">' . __('Shortcode.css', 'themify') . '</span><input type="checkbox" name="setting-shortcode_css" '.$shortcode_checked.' /> ' . __('Exclude shortcodes.css', 'themify') . ' <br> <small>' . __('(check this to exclude shortcodes.css)', 'themify') . '</small></p>';	
...
/***************************************************************************/	
	...
	function themify_background_image($data=array()){	
		...
		$output .= '<p class="background_image">
						...
						<span class="pushlabel" style="display:block;">
							<a href="#" class="upload-btn upload-image" id="styling-'.$data['category'].'-'.$data['title'].'">' . __('+ Upload', 'themify') . '</a>
						</span>
					</p>';		
		return $output;
	}

...
if (!class_exists('simple_modal_login')) {
	...
	<form name="loginform" id="loginform" action="%s" method="post">
		...
		<p>
			<label>%s<br />
			<input type="text" name="log" class="user_login input" value="%s" size="20" tabindex="10" /></label>
		</p>
		<p>
			<label>%s<br />
			<input type="password" name="pwd" class="user_pass input" value="%s" size="20" tabindex="20" /></label>
		</p>',

...
function themify_theme_enqueue_scripts(){
	...
	wp_enqueue_style( 'themify-style', get_bloginfo('stylesheet_url'));
	...
	wp_enqueue_style( 'google-fonts', 'http://fonts.googleapis.com/css?family=Radley:400,400italic|Damion');
